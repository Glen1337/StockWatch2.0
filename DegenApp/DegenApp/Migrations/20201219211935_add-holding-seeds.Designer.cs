...
namespace DegenApp.Migrations
{
    ...
    [Migration("20201219211935_add-holding-seeds")]
    partial class addholdingseeds
    {
            ...
            modelBuilder.Entity("DegenApp.Models.Holding", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StrikePrice = 0m,
                            Symbol = "NKE",
                            TransactionDate = new DateTime(2020, 12, 19, 16, 19, 35, 525, DateTimeKind.Local).AddTicks(6349),
                            Type = "share"
                        },
                        new
                        {
                            ...
                            StrikePrice = 0m,
                            Symbol = "SNAP",
                            TransactionDate = new DateTime(2020, 12, 19, 16, 19, 35, 525, DateTimeKind.Local).AddTicks(7294),
                            Type = "share"
                        },
                        new
                        {
                            ...
                            StrikePrice = 0m,
                            Symbol = "FSLR",
                            TransactionDate = new DateTime(2020, 12, 19, 16, 19, 35, 525, DateTimeKind.Local).AddTicks(7323),
                            Type = "share"
                        },
                        new
                        {
                            ...
                            StrikePrice = 0m,
                            Symbol = "SPOT",
                            TransactionDate = new DateTime(2020, 12, 19, 16, 19, 35, 525, DateTimeKind.Local).AddTicks(7340),
                            Type = "share"
                        });
                });
            ...
            modelBuilder.Entity("DegenApp.Models.Portfolio", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PortfolioId = 1L,
                            CreationDate = new DateTime(2020, 12, 19, 16, 19, 35, 522, DateTimeKind.Local).AddTicks(9707),
                            GainLoss = 768.00m,
                        ...
                        {
                            PortfolioId = 2L,
                            CreationDate = new DateTime(2020, 12, 22, 21, 24, 20, 525, DateTimeKind.Local).AddTicks(3985),
                            GainLoss = -324.67m,
                        ...
                        {
                            PortfolioId = 3L,
                            CreationDate = new DateTime(2021, 1, 11, 23, 42, 41, 525, DateTimeKind.Local).AddTicks(4105),
                            GainLoss = 19874.73m,
