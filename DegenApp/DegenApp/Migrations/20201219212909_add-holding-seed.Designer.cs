...
namespace DegenApp.Migrations
{
    ...
    [Migration("20201219212909_add-holding-seed")]
    partial class addholdingseed
    {
            ...
            modelBuilder.Entity("DegenApp.Models.Holding", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StrikePrice = 0m,
                            Symbol = "NKE",
                            TransactionDate = new DateTime(2020, 12, 19, 16, 29, 9, 112, DateTimeKind.Local).AddTicks(6865),
                            Type = "share"
                        },
                        new
                        {
                            ...
                            StrikePrice = 0m,
                            Symbol = "SNAP",
                            TransactionDate = new DateTime(2020, 12, 19, 16, 29, 9, 114, DateTimeKind.Local).AddTicks(2371),
                            Type = "share"
                        },
                        new
                        {
                            ...
                            StrikePrice = 0m,
                            Symbol = "FSLR",
                            TransactionDate = new DateTime(2020, 12, 19, 16, 29, 9, 114, DateTimeKind.Local).AddTicks(2415),
                            Type = "share"
                        },
                        new
                        {
                            ...
                            StrikePrice = 0m,
                            Symbol = "SPOT",
                            TransactionDate = new DateTime(2020, 12, 19, 16, 29, 9, 114, DateTimeKind.Local).AddTicks(2433),
                            Type = "share"
                        },
                        new
                        {
                            ...
                            StrikePrice = 0m,
                            Symbol = "ROKU",
                            TransactionDate = new DateTime(2020, 12, 19, 16, 29, 9, 114, DateTimeKind.Local).AddTicks(2447),
                            Type = "share"
                        });
                });
